...
const CustomSeqPlayground = ({ feature, saeName }: CustomSeqPlaygroundProps) => {
  ...
  useEffect(() => {
    if (
      ...
      setCustomSeqInput(urlState.pdb || urlState.seq);
      handleSubmit(urlState.pdb || urlState.seq);
    }
  }, [urlState, setCustomSeqInput, handleSubmit]);
